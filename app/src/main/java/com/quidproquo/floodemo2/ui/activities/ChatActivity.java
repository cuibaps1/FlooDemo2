...
import com.quidproquo.floodemo2.LangExDemoApp;
import com.quidproquo.floodemo2.R;
import com.quidproquo.floodemo2.ui.fragments.ChatFragment;
...
//        mToolbar.setTitle(getIntent().getExtras().getString(Constants.ARG_RECEIVER));
    ...
    protected void onResume() {
        super.onResume();
        LangExDemoApp.setChatActivityOpen(true);
    }

    @Override
    protected void onPause() {
        super.onPause();
        LangExDemoApp.setChatActivityOpen(false);
    }
